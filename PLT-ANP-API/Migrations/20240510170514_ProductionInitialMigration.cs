...
{
    public partial class ProductionInitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TempUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subject = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResponseMessage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChangeOrResetUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NewUserActivationToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "8fb06856-e313-4457-b15a-349a3a630600", "169e121e-bbcc-4341-94f1-18af8c2414aa", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "e7f94863-0595-45ea-9e97-b3786c934c08", "11cc467d-d305-4448-ad58-f4277b4e227c", "Staff", "STAFF" });
